...
We used the`R`programming language [@citeR], the `here` package [],
the `dplyr` package [@R_dplyr], the `tidyr` package [@R_tidyr], the `maps` package [@R_maps], the `ggplot2` package [@R_ggplot2], and the`scale` package [@R_scales] to clean the data. We used the `tidyverse` package [@tidyverse], the `maps` package [@maps], the `ggplot2` package [@R_ggplot2], the `knitr` package [@knitr], the `kableExtra` package [@kableExtra] to plot the dataset and the visualization. 
...
```{r}
#| label: tlb-data-overview
#| tib-cap: The specific columns in the dataset
#| echo: false
#| warning: false
...
kable(summary_data, 
      col.names = c("Year", "State", "School Type", "Top 1 Race", "Ulocale", "Data Source", "School Shooting"),
...
We use the `brms` package [@brms] and the `bayesplot` package [@bayesplot] to fit the model. 
